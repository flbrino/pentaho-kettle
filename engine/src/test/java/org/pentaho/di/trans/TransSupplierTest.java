...
public class TransSupplierTest {
  ...
  @Mock Trans trans;
  @Mock TransMeta meta;
  @Mock Supplier<Trans> fallbackSupplier;
  @Mock LogChannelInterface log;
  @Mock TransHopMeta transHopMeta;
  ...
  @Test
  public void testRSAVersion() throws KettleException {
    ...
    assertTrue( transRet instanceof TransEngineAdapter );
  }
